    ...
    render() {
        return (
          <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.sub_view} onPress={NavigationActions.notifications1}>
              <Text style={styles.text}>Notifications</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.sub_view} onPress={NavigationActions.about1}>
